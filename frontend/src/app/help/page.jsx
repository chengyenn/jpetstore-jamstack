...
const lists = [
  { id: "#SigningUp", title: "Signing Up", content: "" },
  { id: "#SigningIn", title: "Signing In" },
  { id: "#Catalog", title: "Working with the Product Catalog" },
  { id: "#CatalogBrowsing", title: "Browsing the Catalog" },
  { id: "#CatalogSearching", title: "Searching the Catalog" },
  { id: "#ShoppingCart", title: "Working with the Shopping Cart" },
  { id: "#ShoppingCartAdd", title: "Adding and Removing Items" },
  { id: "#ShoppingCartUpdate", title: "Updating the Quantity of an Item" },
  { id: "#Ordering", title: "Ordering Items" },
  { id: "#OrderReview", title: "Reviewing an Order" },
];
...
export default function Help() {
  return (
    <div id="Content">
      ...
      <ul>
        {lists.map((list) => (
          <ListShow key={list.id} title={list.title} id={list.id} />
        ))}
      </ul>
      ...
      <h2>
        <a id="Catalog"></a>Working with the Product Catalog
      </h2>
      <p>
